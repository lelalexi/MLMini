...
extension ProductDetailViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = productDetailCarrouselCollectionView.dequeueReusableCell(withReuseIdentifier: Constants.DETAIL_PRODUCT_IMAGE_CELL, for: indexPath ) as? ProductImageViewCell else { return UICollectionViewCell() }
